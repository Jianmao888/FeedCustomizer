...
file sealed unsafe class ComClassInformation : global::System.Runtime.InteropServices.Marshalling.IComExposedClass
{
    ...
    public static global::System.Runtime.InteropServices.ComWrappers.ComInterfaceEntry* GetComInterfaceEntries(out int count)
    {
        ...
        if (s_vtables == null)
        {
            ...
            details = global::System.Runtime.InteropServices.Marshalling.StrategyBasedComWrappers.DefaultIUnknownInterfaceDetailsStrategy.GetIUnknownDerivedDetails(typeof(FeedProvider.Com.IClassFactory).TypeHandle);
            vtables[0] = new()
            {
                IID = details.Iid,
...
namespace FeedProvider
{
    ...
    internal partial class FeedProviderFactory
    {
    }
}
